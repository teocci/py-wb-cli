...
| **Tests Passing** | 1659/1660 (31 new in I-26; 1 pre-existing env-leak in `test_auth_list_empty`) |
| **Phases Complete** | 63 |
...
| I-15 | Cooldown-tied HTTP-layer request cache + `wb api-cache` diag (renamed to `wb cache` in I-16) | ✅ DONE | 0.32.0 |
...
| I-17 | Status filter on campaign discovery for `product-spend` (Base cooldown reduction) | ✅ DONE | 0.34.0 |
